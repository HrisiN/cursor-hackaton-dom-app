    ...
    <header className="sticky top-4 z-50 mx-4">
      <nav className="mx-auto max-w-5xl flex items-center justify-between rounded-full border border-dom-border/50 bg-white/70 px-4 py-2.5 shadow-moss backdrop-blur-md">
        <a href="/" className="flex items-center gap-2.5">
          ...
          <span className="font-fraunces text-2xl tracking-tight text-dom-fg"><span className="font-900">D</span><span className="font-900 text-dom-primary">o</span><span className="font-900">m</span></span>
        </a>
