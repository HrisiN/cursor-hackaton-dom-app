...
export function MarketInsight() {
  return (
    <div className="rounded-2xl border border-dom-border/60 bg-dom-card p-4 shadow-moss space-y-3">
      <h3 className="font-fraunces font-700 text-sm">Zagreb Market Pulse</h3>
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-0.5">
          <p className="text-xs text-muted-foreground">Avg. sale price/m²</p>
          <p className="text-lg font-bold">€2,450</p>
          <p className="text-[10px] text-dom-primary font-600">▲ +3.2% vs 2025</p>
        </div>
        <div className="space-y-0.5">
          <p className="text-xs text-dom-muted-fg">Avg. rent/m²</p>
          <p className="text-lg font-fraunces font-700">€12.80</p>
          <p className="text-[10px] text-dom-primary font-600">▲ +1.8% vs 2025</p>
        </div>
      </div>
